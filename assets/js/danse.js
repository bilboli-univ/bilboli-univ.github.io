// =====================================================
//  Galerie Danse — Virtualisation + Thumbnails
// =====================================================
(function initDanseGallery() {

    const container = document.querySelector("#danse .photo-grid");
    if (!container) return;
    ...
    // Charger JSON
    fetch("../../assets/img/danse/photos.json")
        .then(r => r.json())
        .then(data => {
            photos = data;
            loadNextBatch();
    ...
    function loadNextBatch() {
        ...
        slice.forEach(file => {
            const thumb = `../../assets/img/danse/thumb/${file}`;
            const full  = `../../assets/img/danse/full/${file}`;
