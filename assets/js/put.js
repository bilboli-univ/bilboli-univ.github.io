// =====================================================
//  Galerie put — Virtualisation + Thumbnails
// =====================================================
(function initPutGallery() {

    const container = document.querySelector("#put .photo-grid");
    if (!container) return;
    ...
    // Charger JSON
    fetch("../../assets/img/put/photos.json")
        .then(r => r.json())
        .then(data => {
            photos = data;
            loadNextBatch();
    ...
    function loadNextBatch() {
        ...
        slice.forEach(file => {
            const thumb = `../../assets/img/put/thumb/${file}`;
            const full  = `../../assets/img/put/full/${file}`;
