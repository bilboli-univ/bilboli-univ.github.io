// =====================================================
//  Gala 2026 — Virtualisation + Thumbnails
// =====================================================
(function initDanseGallery() {

    const container = document.querySelector("#gala_2026 .photo-grid");
    if (!container) return;
    ...
    // Charger JSON
    fetch("../../assets/img/gala_2026/photos.json")
        .then(r => r.json())
        .then(data => {
            photos = data;
            loadNextBatch();
    ...
    function loadNextBatch() {
        ...
        slice.forEach(file => {
            const thumb = `../../assets/img/gala_2026/thumb/${file}`;
            const full  = `../../assets/img/gala_2026/full/${file}`;
